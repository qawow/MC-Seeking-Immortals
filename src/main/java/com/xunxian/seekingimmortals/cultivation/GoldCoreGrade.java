    ...
    private static int getPhysiqueScore(SpecialPhysique physique) {
        return switch (physique == null ? SpecialPhysique.NONE : physique) {
            ...
            case HIDDEN_THUNDER_ROOT, JADE_PHOENIX_MARROW, GOLD_FORGING_BODY, MOLTEN_GOLD_BODY,
                    THREE_YANG_BODY, CHARMING_BODY, SELF_GOVERN_BODY -> 4;
            case FIVE_THUNDER_BODY, NINE_SPIRIT_SWORD_BODY, HEAVENLY_YIN_BODY, MYSTIC_YIN_BODY,
                    TRUE_SPIRIT_BLOODLINE, SWORD_INTENT_BODY, UNDYING_BODY -> 7;
            case SEVEN_STAR_MOON_BODY, CHASTE_YIN_BODY, VAJRA_BODY, VOID_SHADOW_BODY -> 6;
        };
    }
