...
/**
 * Text-material refinement forge multiblock:
 * 3x3 base of forge blocks on y=0 excluding center, plus four corner pillars y=1..2 of frameBlock.
 */
public final class RefinementForgeStructure {
    ...
    private RefinementForgeStructure() {}
