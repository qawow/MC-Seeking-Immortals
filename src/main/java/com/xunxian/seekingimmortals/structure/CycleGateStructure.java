...
/**
 * Cycle gate / void palace prestige gate: radius-4 ring + pillars y=1..5 + clear 7x7x5 aperture.
 * Text-material node type: cycle_gate.
 */
public final class CycleGateStructure {
