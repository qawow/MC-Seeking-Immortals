...
/**
 * Ancient rift gate: radius-3 ring + spirit-ore pillars y=1..4 + clear 5x5x4 aperture.
 * Text-material node type: ancient_rift.
 */
public final class AncientRiftGateStructure {
    ...
    private AncientRiftGateStructure() {}
