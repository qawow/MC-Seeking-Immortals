...
/**
 * Defense formation zone: outer-edge ring radius 2 at y=0 (16 blocks, center excluded).
 * Center is the defense formation core; ring uses spirit_ore placeable nodes to differentiate
 * from spirit-gather formations. Text-material / formation_catalog node type: defense_wall placeable.
 */
public final class DefenseFormationStructure {
    public static final int RING_RADIUS = 2;

    private static final List<BlockPos> RING_OFFSETS = buildRingOffsets();

    private DefenseFormationStructure() {}
