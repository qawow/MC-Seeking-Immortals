...
public class ArmorTalismanItem extends Item {
    private static final int QI_COST = 8;
    private static final Realm MIN_REALM = Realm.QI_REFINING;
    private static final String AFFINITY = "土/金/冰";
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            CultivationHelper.get(player).ifPresent(cultivation -> {
                ...
                int amplifier = TechniqueAffinityCalculator.getEffectAmplifierBonus(cultivation, AFFINITY);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.seeking_immortals.armor_talisman.desc").withStyle(ChatFormatting.GRAY));
